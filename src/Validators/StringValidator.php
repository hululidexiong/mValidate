...
class StringValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->encoding === null) {
            $this->encoding = Bear::$charset;
        }
        if ($this->message === null) {
            $this->message = Bear::t( '{attribute} must be a string.');
        }
        if ($this->min !== null && $this->tooShort === null) {
            $this->tooShort = Bear::t( '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.');
        }
        if ($this->max !== null && $this->tooLong === null) {
            $this->tooLong = Bear::t( '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.');
        }
        if ($this->length !== null && $this->notEqual === null) {
            $this->notEqual = Bear::t( '{attribute} should contain {length, number} {length, plural, one{character} other{characters}}.');
        }
    }
